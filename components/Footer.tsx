    ...
    <footer className="bg-slate-900 dark:bg-black text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-bold mb-4">Vineela Sridhara</h3>
            <p className="text-slate-400">
              Senior Software Engineer passionate about building impactful
              solutions
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center text-slate-400 text-sm">
          <p>© {currentYear} Vineela Sridhara. All rights reserved.</p>
          <p className="mt-4 md:mt-0">
            ...
            deployed on{" "}
            <span className="text-blue-400 font-semibold">Netlify</span>
          </p>
        </div>
      </div>
    </footer>
